...
return [
    ...
    "col_electronic_range_resolution"           => "Resolución Autorización Facturación",
    "col_electronic_range_start_date"           => "Fecha de Inicio Resolución",
    "col_electronic_range_end_date"             => "Fecha de Fin Resolución",
    "col_electronic_prefix"                     => "Prefijo de Factura",
    "col_electronic_credit_resolution"          => "Resolución Autorización Nota Crédito",
    "col_electronic_credit_range_start_date"    => "Fecha de Inicio Resolución Nota Crédito",
    "col_electronic_credit_range_end_date"      => "Fecha de Fin Resolución Nota Crédito",
    "col_electronic_credit_range_min"           => "Rango Min Nota Crédito",
    "col_electronic_credit_range_max"           => "Rango Max Nota Crédito",
    "col_electronic_credit_prefix"              => "Prefijo Nota Crédito",
    "comma"                                     => "coma",
    ...
    "dian_configuration"                        => "Configuración DIAN",
    "dian_software_system"                      => "Software y Sistema",
    "dian_certificates"                         => "Certificados",
    "dian_invoices"                             => "Configuración de Facturación",
    "dian_credit_notes"                         => "Configuración de Notas de Crédito",
    "dinner_table"                              => "Mesa",
    ...
    "last_used_credit_note_number"              => "Último número de nota de crédito utilizado",
