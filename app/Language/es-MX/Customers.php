...
return [
    ...
    "city_required"                 => "La ciudad es un campo requerido.",
    ...
    "country_required"              => "El país es un campo requerido.",
    ...
    "email_required"                => "El correo electrónico es un campo requerido.",
    "employee"                      => "Empleado",
    ...
    "tax_id_required"               => "El Id Impuesto es un campo requerido.",
