...
<body>
    ...
    <div id="page-wrap">
        <div id="header"><?= lang('Sales.credit_note') ?></div>
        <table id="info">
            <tr>
                <td id="logo">
            ...
            <tr>
                ...
                <td id="meta">
                    <table id="meta-content" align="right">
                        <tr>
                            <td class="meta-head"><?= lang('Sales.credit_note_number') ?></td>
                            <td><?= esc($credit_debit_id) ?></td>
                        </tr>
                        <tr>
                            <td class="meta-head"><?= lang('Common.date') ?></td>
                            <td><?= esc(to_date(time())) ?></td>
                        </tr>
                        <?php if ($amount_due > 0) { ?>
                            <tr>
        ...
        <div id="terms">
            <div id="sale_return_policy">
                <h5>
                    <span><b><?= nl2br($config['payment_message']) ?></b></span>
                    <span><b><?= lang('Sales.credit_note_comment') ?></b></span>
                    <span><b><?= lang('Sales.invoice_reference') . ': ' . $invoice_number ?></b></span>
                    <span><b><?= lang('Common.date') . ': ' . esc($transaction_date) ?></b></span>
                </h5>
            </div>
            <div id="barcode">
                <p> CUDE: <?= $cufe ?></p>
